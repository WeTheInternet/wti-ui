...
public class TaskTableComplete extends AbstractTaskTable<ModelTaskCompletion, TaskViewComplete> {
    ...
    @Override
    public TaskViewComplete addTask(final ModelTaskCompletion model) {
