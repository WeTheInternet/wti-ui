...
public class TaskTableDefinitions extends AbstractTaskTable<ModelTaskDescription> {
    ...
    @Override
    public IsTaskView<ModelTaskDescription> addTask(final ModelTaskDescription model) {
