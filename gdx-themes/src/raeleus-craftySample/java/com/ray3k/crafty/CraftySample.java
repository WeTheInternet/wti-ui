...
import net.wti.gdx.theme.raeleus.crafty.GdxThemeCrafty;

/// CraftySample:
///
/// Adapted from theme example zip from [Raeleus blog](https://ray3k.wordpress.com/craftacular-ui-skin-for-libgdx)
///
/// Created by James X. Nelson (James@WeTheInter.net) on 13/02/2025 @ 02:22
public class CraftySample  extends ApplicationAdapter {
    ...
    public static void main(String[] args) {
        ...
        new Lwjgl3Application(new CraftySample(), config);
    }

    @Override
    public void create() {
        value = 0.0f;
        final GdxThemeCrafty theme = new GdxThemeCrafty();
        skin = theme.getSkin();
